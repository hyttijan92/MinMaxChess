    ...
    return (
        <>
            ...
            <div className="container mx-auto grid justify-center">
                ...
                <div class="rounded shadow-md bg-gray-200 border-solid  grid grid-cols-5">
                ...
                {previousGames.map(previousGame => {
                    return (
                        <div class="rounded shadow-md bg-gray-200 border-solid border-1 break-all border-indigo-400  grid grid-cols-5">
